                         ...
                         <div class="search_banner">
                                <div>
	                                ...
	                                <div class="input-group" style="padding:5px;">
		                                <lable class="pull-left">分组名称：<input id="name" style="width:100px" type="text" value="" /></lable><br>
		                             </div>
                            ...
                            <table id="basicTable" class="table table-striped table-bordered responsive">
                                ...
                                <tbody>
                                  ...
                                  <tr role="row" class="even"><td>1</td><td>lzm</td><td><a href="./departMentEdit">编辑</a>|删除</td></tr>
                                </tbody>
                            </table>
                        </div><!-- panel -->
