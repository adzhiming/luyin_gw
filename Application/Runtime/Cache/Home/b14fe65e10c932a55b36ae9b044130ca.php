                         ...
                         <div class="search_banner">
                                <div>
	                                ...
	                                <div class="input-group" style="padding:5px;">
		                                <lable class="pull-left">新增IP地址：<input id="name" style="width:100px" type="text" value="" /></lable><br>
		                             </div>
		                             
	                                </div>
	                                <div class="pull-left col-md-8">
											<button class="btn btn-info btn-large">提交</button>
                            ...
                            <table id="basicTable" class="table table-striped table-bordered responsive">
                                ...
                                <tbody>
                                  <tr role="row" class="odd">
                                     <td>192.168.1.5</td>
                                     <td><select><option>允许访问</option><option>禁止访问</option></select></td>
                                     <td>删除</td>
                                  </tr>
                                </tbody>
                            </table>
