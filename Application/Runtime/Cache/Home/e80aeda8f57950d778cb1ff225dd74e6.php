                    ...
                    <div class="contentpanel">
                        ...
                        <div class="search_banner">
                             <div class="pull-left col-md-1">
	                                <a class="btn btn-info btn-large" href="../Account/userAdd">普通参数</a>
	                          </div> 
	                          <div class="pull-left col-md-1">
	                                <a class="btn btn-info btn-large" href="../Account/userAdd">高级参数</a>
	                          </div>
                             <div class="pull-left col-md-1">
                        ...
                        <div class=" col-md-12">
	                                <input class="btn btn-info btn-large" type="button" value="提交参数">
	                    </div> 
